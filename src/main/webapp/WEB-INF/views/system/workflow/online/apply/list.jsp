			...
			<div class="col-xs-12">
				<form id='leaveFrom' class="form-horizontal" method="POST" onsubmit="return false;">
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" name="org" jyValidate="required"  maxlength="32" class="col-xs-12 col-sm-12" >
						</div>	
						<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>申请人</label>
						<div class="col-sm-2">
							<input type="text" name="name" jyValidate="required" maxlength="16" class="col-xs-12 col-sm-12" >
						</div>	
						<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>审批人</label>
						<div class="col-sm-2">
							<input type="text" name="approver" jyValidate="required"  maxlength="16" class="col-xs-12 col-sm-12"  >
						</div>	
					</div>
